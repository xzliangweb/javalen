package com.example.itheima_reggie_take.utils;
...
public class SMSUtils {
	...
	public static void sendMessage(String signName, String templateCode,String phoneNumbers,String code){
		DefaultProfile profile = DefaultProfile.getProfile("cn-changsha", "LTAI5tP1YrfygTrZNfBM4HFA", "aHmFdvWpvHswh9tHRIoAVYdsEDCUc2");
		/** use STS Token
